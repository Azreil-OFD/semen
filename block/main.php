    ...
    <main>
        ...
        <article class="block">
            <div id="3" class="info card third">
                ...
                <a href="https://vk.com/gumkorpus86?w=wall-216262291_57%2Fall" class="vk" target="_blank"><img
                        src="image/vk.png" class="vk_img"></a>
            </div>
        </article>
        <article class="block">
        ...
        <article class="block">
            <div id="9" class="info card first">
                ...
                <a href="https://vk.com/heart_of_ugra?z=photo370021885_457243517%2Fwall-204962426_223" class="vk"
